...
The overall accuracy rate for our random forest model is 25.8%, showing that overall, the model is has a somewhat weak ability to predict the accurate felony severity category.
...
The accuracy rate is 11.226% for the KNN model, which is lower than our random forest model.
