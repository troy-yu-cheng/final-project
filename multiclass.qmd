...
The overall accuracy rate for our random forest model is 19.61%, showing that overall, the model is has a somewhat weak ability to predict the accurate felony severity category.
...
```
The accuracy rate is 12.16% for the KNN model, which is lower than our random forest model.
