...
#cart_fit <- fit(cart_wf, data = multiclass_train)

#cart_predict <- predict(cart_fit, multiclass_test, type = "class")

#metrics(cart_predict, truth = felony_severity, estimate = .pred_class)

#conf_mat(cart_predict, truth = felony_severity, estimate = .pred_class)
