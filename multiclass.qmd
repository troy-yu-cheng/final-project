...
The overall accuracy rate for our random forest model is 21.5%, showing that overall, the model is has a somewhat weak ability to predict the accurate felony severity category.
